...
### <img src="https://media.giphy.com/media/VbnUQpnihPSIgIXuZv/giphy.gif" width="30" height="30"/> `whoami`

```typescript
const rodrigo = {
  alias: "rodrigomart123",
  location: "🌍 Portugal",
  role: "Full-Stack Developer",
  code: ["JavaScript", "TypeScript", "Python", "C#"],
  tools: {
    frontend: ["React", "Next.js", "Vue", "TailwindCSS"],
    backend:  ["Node.js", ".NET", "Express", "FastAPI"],
    database: ["PostgreSQL", "MongoDB", "Redis"],
    devops:   ["Docker", "GitHub Actions", "Azure", "Linux"],
  },
  currentlyLearning: ["Rust", "Kubernetes", "AI/ML"],
  askMeAbout: ["Web Dev", "Cloud", "Open Source", "Tech in general"],
  funFact: "I debug with coffee ☕ and ship with caffeine 🚀",
};
```
...
### <img src="https://media2.giphy.com/media/QssGEmpkyEOhBCQL7e/giphy.gif" width="30" height="30"/> `tech --stack`

<details open>
<summary><b>💻 Languages</b></summary>
<br/>
<p>
  <img src="https://skillicons.dev/icons?i=js,ts,python,cs,java,go&theme=dark" alt="Languages"/>
</p>
</details>
...
<br/>
<p>
  <img src="https://skillicons.dev/icons?i=react,nextjs,vue,tailwind,sass,html,css&theme=dark" alt="Frontend"/>
</p>
</details>
...
<br/>
<p>
  <img src="https://skillicons.dev/icons?i=nodejs,express,dotnet,fastapi,postgres,mongodb,redis,mysql&theme=dark" alt="Backend"/>
</p>
</details>
...
<br/>
<p>
  <img src="https://skillicons.dev/icons?i=git,github,vscode,docker,azure,linux,bash,postman&theme=dark" alt="DevOps"/>
</p>
</details>
...
### <img src="https://github.githubassets.com/images/icons/emoji/trophy.png" width="30" height="30"/> `cat trophies.md`

<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=rodrigomart123&theme=github_dark&no-frame=true&no-bg=true&margin-w=4&column=7" alt="Trophies"/>
</div>
...
### <img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="30" height="30"/> `git commit -m "hack the planet"`

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/rodrigomart123/rodrigomart123/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/rodrigomart123/rodrigomart123/output/github-snake.svg" />
  <img alt="github contribution snake" src="https://raw.githubusercontent.com/rodrigomart123/rodrigomart123/output/github-snake-dark.svg" />
</picture>
